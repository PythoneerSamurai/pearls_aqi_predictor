...
The trained models are then deployed on Hopsworks after the removal of the previously stored and deployed models.

The frontend is designed in Streamlit and is deployed at: https://haroons-pearls-aqi-predictor.streamlit.app/
